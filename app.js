...
const alquileresRoute = require("./routes/alquileres");
const pasajesRoute = require("./routes/pasajes");
...
app.use("/alquileres", alquileresRoute);
app.use("/mantenimientos", mantenimientoRoute);
app.use("/pasajes", pasajesRoute);
